...
public class GenerarDatos implements IGeneracionDatos {
    ...
    public void generarDatos() {
        ...
        if(repoUsuario.findAll().isEmpty()){
            ...
            repoUsuario.save(new Usuario(2, "María", "Gómez", "C/Zaragoza", "Zaragoza", "maria@correo.com", "666655566", null, null, null, "src/main/resources/static/upload/maria.jpg", Boolean.FALSE));
        ...
        if(repoRelato.findAll().isEmpty()){
            repoRelato.save(new Relato(1, "src/main/resources/static/ficheros/Relato.txt",repoUsuario.findById(1).get(), "Relato 1", 0.0, 0, repoGen.findById(1).get()));
        }
